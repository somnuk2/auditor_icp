...
export default {
  ...
  methods: {
    ...
    resetForm() {
      ...
      self.plan_career.value = "";
      self.plan_career.label = "";
      self.plan_career.description = "";

      self.qa_plan_career.value = "";
      self.qa_plan_career.label = "";
      self.qa_plan_career.description = "";
      self.qa_plan_career_description = "";
      self.perform_id = "";
      self.self_assessment_date = "";

      self.self_assessment_id = "";
    },
    getAllUser() {
    ...
    onDescription(qa_plan_career_id) {
      if (qa_plan_career_id != null) {
        ...
        console.log("level:", qa_plan_career_id.level);

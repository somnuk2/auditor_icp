...
if ($request_data->action == "insert") {
    ...
    $member_id = (int) $request_data->member_id;
    $query = "SELECT qpc.qa_plan_career_id,
                     pla.plan_career_id, pla.member_id, pla.career_id, cag.ca_group_name,
                     mem.created_by,mem.full_name,mem.status,
                     inv.advisor_id,
                     car.career_name,
            ...
            LEFT OUTER JOIN individual           AS inv ON mem.member_id = inv.member_id
    ...
    $query = "SELECT qap.qa_plan_career_id,
                     pla.plan_career_id,pla.start_date, 

...
if ($request_data->action == "insert") {
    ...
    $member_id = (int)$request_data->member_id;
    $query = "SELECT pla.plan_career_id, pla.member_id, pla.career_id, car.career_name,pla.start_date
    ...
    $member_id = (int)$request_data->member_id;
    $query = "SELECT pla.plan_career_id, pla.start_date,
                     pla.member_id, mem.full_name, mem.status,mem.created_by,
                     ind.individual_id,ind.advisor_id,
                     pla.career_id, car.career_name, cag.ca_group_name
    ...
    $query = "SELECT pla.plan_career_id, pla.start_date,  
                     pla.member_id, mem.full_name, mem.status,
                     pla.career_id, car.career_name, cag.ca_group_name 
